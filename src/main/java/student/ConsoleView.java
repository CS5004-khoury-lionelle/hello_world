...
public final class ConsoleView {
    ...
    private static final Scanner SCANNER = new Scanner(System.in); // System.in is a standard input stream
    ...
    // get the options from the Greeter class, doing this here, so it is only called once
    ...
    public static String getName() {
        // these two combined statements are similar to input("Welcome, what is your name? "), in python
        System.out.print("Welcome, what is your name? "); // this is a print statement, notice the print vs println used below
